  ...
  useEffect(() => {   
    ...
    const tick = async () => {
      try {
        ...
        setWisdom(data.wisdom || data.text || data.lesson || "...");
        setLessonId(data.id?.toString() || data.number?.toString() || "??");
    ...
    <div id="app">
      ...
      {showPrivateImage && (
        <div className="secret-image-overlay" onClick={() => setShowPrivateImage(false)}>
          <img src="pupa.jpeg" alt="Secret Pupa" style={{width: '300px', backgroundColor: 'white'}} />
      ...
      <main className="main-layout">
        ...
        <aside className="col-left">
          <div className="korvo-ad-box">
            ...
            <div className="car-container" style={{ position: 'relative', width: '100%', marginTop: '10px' }}>
                ...
                <div className="lesson-display">
                  ...
                  {!spinning && showShare && (
                    <div className="share-box" style={{ display: 'flex', alignItems: 'center', gap: '10px', marginTop: '30px' }}>
                      ...
                      <img src="/fb-logo.96f2b976.png" style={{ height: '35px', cursor: 'pointer' }} alt="Facebook" />
                      <img src="/twitter-logo.ebe3c4fc.png" style={{ height: '35px', cursor: 'pointer' }} alt="Twitter" />
                    </div>
                  )}
                </div>
              )}
